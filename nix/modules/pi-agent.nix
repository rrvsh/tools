      ...
      in
      {
        ...
        programs.pi-coding-agent = {
          ...
          context = ''
            ...
            Always use plain english. Never use mannered prose.
            Always make sure prose output is as simplified and readable as possible without losing meaning or resolution.
